package com.bridgelabz.cartservice.aop;
...
public class AOPService {
    ...
    @Before("execution(* com.bridgelabz.cartservice.controller.CartController.*(..))")     //point-cut expression
    public void logBeforeV1(JoinPoint joinPoint) {
        log.info("Executing API : " + joinPoint.getSignature().getName() + " ");
    }

    //logs method After hitting API
    @After("execution(* com.bridgelabz.cartservice.controller.CartController.*(..))")     //point-cut expression
    public void logAfter(JoinPoint joinPoint) {
        log.info("API successfully Executed : " + joinPoint.getSignature().getName() + " ");
    }

    //logs parameters After hitting API
    @After("execution(* com.bridgelabz.cartservice.controller.CartController.*(..))")
    public void logAfterAndSaveArgs(JoinPoint joinPoint) {
        log.info("After : " + Arrays.toString(joinPoint.getArgs()));
    }
//    TimeTaken
    @Around(value = "execution(* com.bridgelabz.cartservice.controller.CartController.*(..))")
